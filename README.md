...
- 🛠️ 100 projects examples → [Link](./chapters/Download_install_start.md) and scripts → [Link](https://github.com/massimovar/LearningFTOptix/blob/main/chapters/Ready_to_use_scripts.md)
